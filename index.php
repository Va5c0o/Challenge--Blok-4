                        ...
                        <img class="card-img-top" src="images/<?php echo $cottages["cottage_img"]?>" alt="cottage_name"><!-- maak image en naam dynamisch -->
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">€ <?php echo $cottages["cottage_price_a"] . " per nacht voor volwassenen"?></li><!-- maak prijs volwassenen dynamisch -->
                                    <li class="list-group-item">€ <?php echo $cottages["cottage_price_c"] . " per nacht voor kinderen"?></li><!-- maak prijs kinderen dynamisch -->
                                </ul>
                                <a href="huisjes.php?cottageID=<?php echo $cottages["cottage_id"]; ?>" class="btn btn-secondary mt-2">Lees meer...</a><!-- maak href dynamisch -->
                            </div>
                        </div>
                    </div>
